...
public class C33MethodsTest extends MethodPresenterTestBase {
    ...
    public void test_for_method_3() {
        expectedConsecutiveLines = List.of(
                "  abstract long f2(long, long, long, long...) throws com.test.presenter.C33$MyException, java.lang.IndexOutOfBoundsException, java.lang.NullPointerException, java.lang.ClassNotFoundException;",
                "    descriptor: (JJJ[J)J",
                "    flags: (0x0480) ACC_VARARGS, ACC_ABSTRACT",
                "    Exceptions:",
                "      throws com.test.presenter.C33$MyException, java.lang.IndexOutOfBoundsException, java.lang.NullPointerException, java.lang.ClassNotFoundException"
        );
    }
    ...
    public void test_for_method_9() {
        expectedConsecutiveLines = List.of(
                "  abstract com.test.presenter.C33$Level2 f8(com.test.presenter.C33$Level2[], com.test.presenter.C33$Level2...);",
                "    descriptor: ([Lcom/test/presenter/C33$Level2;[Lcom/test/presenter/C33$Level2;)Lcom/test/presenter/C33$Level2;",
                "    flags: (0x0480) ACC_VARARGS, ACC_ABSTRACT"
        );
    }
    ...
    public void test_for_method_10() {
        expectedConsecutiveLines = List.of(
                "  abstract com.test.presenter.C33$Level2$Level3 f9(com.test.presenter.C33$Level2$Level3...);",
                "    descriptor: ([Lcom/test/presenter/C33$Level2$Level3;)Lcom/test/presenter/C33$Level2$Level3;",
                "    flags: (0x0480) ACC_VARARGS, ACC_ABSTRACT"
        );
    }
    ...
    public void test_for_method_11() {
        expectedConsecutiveLines = List.of(
                "  abstract com.test.presenter.C33$SC f10(com.test.presenter.C33$SC, com.test.presenter.C33$SC, com.test.presenter.C33$SC, com.test.presenter.C33$SC[], com.test.presenter.C33$SC...);",
                "    descriptor: (Lcom/test/presenter/C33$SC;Lcom/test/presenter/C33$SC;Lcom/test/presenter/C33$SC;[Lcom/test/presenter/C33$SC;[Lcom/test/presenter/C33$SC;)Lcom/test/presenter/C33$SC;",
                "    flags: (0x0480) ACC_VARARGS, ACC_ABSTRACT"
        );
    }
    ...
    public void test_for_method_13() {
        expectedConsecutiveLines = List.of(
                "  abstract com.test.presenter.C33$Level2$Level3[][][][][][][][][][][] f12(com.test.presenter.C33$Level2$Level3[][][][][][][][][][][]...);",
                "    descriptor: ([[[[[[[[[[[[Lcom/test/presenter/C33$Level2$Level3;)[[[[[[[[[[[Lcom/test/presenter/C33$Level2$Level3;",
                "    flags: (0x0480) ACC_VARARGS, ACC_ABSTRACT"
        );
    }
    ...
    public void test_for_method_15() {
        expectedConsecutiveLines = List.of(
                "  private com.test.presenter.C33(java.lang.String[]...);",
    ...
    public void test_for_method_16() {
        expectedConsecutiveLines = List.of(
                "  public com.test.presenter.C33(java.lang.String...);",
                "    descriptor: ([Ljava/lang/String;)V",
    ...
    public void test_for_method_17() {
        expectedConsecutiveLines = List.of(
                "  protected com.test.presenter.C33(java.lang.String);",
                "    descriptor: (Ljava/lang/String;)V",
    ...
    public void test_for_method_18() {
        expectedConsecutiveLines = List.of(
                "  com.test.presenter.C33(java.lang.String, int[]...);",
