...
public class ParameterCaseMethodsTest extends MethodPresenterTestBase {
    ...
    public void test_for_method_3() {
        expectedConsecutiveLines = List.of(
                ...
                "    flags: (0x0480) ACC_VARARGS, ACC_ABSTRACT",
                "    Signature: #19                          // ([[Ljava/util/List<[[[I>;[Ljava/util/Optional<Ljava/util/Set<[[J>;>;)I"
        );
    }
    @Test
    public void test_for_method_4() {
        expectedConsecutiveLines = List.of(
                ...
                "    flags: (0x0480) ACC_VARARGS, ACC_ABSTRACT",
                "    Signature: #22                          // (Ljava/util/List<Ljava/lang/Integer;>;[Ljava/util/List<Ljava/lang/Integer;>;[[[Ljava/util/List<Ljava/lang/Integer;>;)V"
        );
    }
    @Test
    public void test_for_method_5() {
        expectedConsecutiveLines = List.of(
                ...
                "    flags: (0x0480) ACC_VARARGS, ACC_ABSTRACT",
                "    Signature: #25                          // (Ljava/util/Map<Ljava/lang/String;Ljava/lang/Long;>;[Ljava/util/Map<Ljava/lang/String;Ljava/lang/Long;>;[[[Ljava/util/Map<Ljava/lang/String;Ljava/lang/Long;>;)V"
        );
    }
    @Test
    ...
    public void test_for_method_7() {
        expectedConsecutiveLines = List.of(
                ...
                "    flags: (0x0480) ACC_VARARGS, ACC_ABSTRACT",
                "    Signature: #31                          // <A_LONG_NAME:Ljava/lang/Object;B:Ljava/lang/Object;>(Ljava/util/Map<TA_LONG_NAME;TB;>;[[[Ljava/util/Map<TA_LONG_NAME;TB;>;)V"
        );
    }
    @Test
    public void test_for_method_8() {
        expectedConsecutiveLines = List.of(
                ...
                "    flags: (0x0480) ACC_VARARGS, ACC_ABSTRACT",
                "    Signature: #34                          // <X:Ljava/lang/String;:Ljava/lang/Runnable;:Ljava/util/function/Supplier<+Ljava/lang/Number;>;>([[Ljava/util/Set<[[Ljava/util/List<TX;>;>;)Ljava/util/function/Function<Ljava/util/function/Function<-Ljava/lang/Object;+Ljava/lang/String;>;+Ljava/lang/Runnable;>;"
        );
    }
    @Test
