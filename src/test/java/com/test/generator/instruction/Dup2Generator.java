...
/**
 * I found that it is not easy to find a class with the "dup2" instruction presented,
 ...
 */
public class Dup2Generator {

    private static final String SIMPLE_CLASS_NAME = "Dup2Case";
    ...
    public static void main(String[] args) throws IOException {
        ...
        {
            methodVisitor = classWriter.visitMethod(Opcodes.ACC_PUBLIC, "test_0x5c", "(II)V", null, null);
            {
                AnnotationVisitor annotationVisitor0 = methodVisitor.visitAnnotation("Lcom/test/cases/method/instruction/Instruction;", true);
                annotationVisitor0.visit("value", 0x5c);
                annotationVisitor0.visit("name", "dup2");
