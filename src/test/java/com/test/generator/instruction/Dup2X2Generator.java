...
/**
 * I found that it is not easy to find a class with the "dup2_x2" instruction presented,
 * so I tried with ASM to generate such class.
 * I used {@link ASMifier} to help generate some content inside the main function
 */
public class Dup2X2Generator {

    private static final String SIMPLE_CLASS_NAME = "Dup2X2Case";
...
//    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        {
            methodVisitor = classWriter.visitMethod(Opcodes.ACC_PUBLIC, "test_0x5e", "(IIII)V", null, null);
            {
                AnnotationVisitor annotationVisitor0 = methodVisitor.visitAnnotation("Lcom/test/cases/method/instruction/Instruction;", true);
                annotationVisitor0.visit("value", 0x5e);
                annotationVisitor0.visit("name", "dup2_x2");
