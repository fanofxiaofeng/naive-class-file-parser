...
/**
 * I found that it is not easy to find a class with the "dup_x2" instruction presented,
...
public class DupX2Generator {
    ...
    private static final String SIMPLE_CLASS_NAME = "DupX2Case";
...
//    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        {
            methodVisitor = classWriter.visitMethod(Opcodes.ACC_PUBLIC, "test_0x5b", "(III)V", null, null);
            {
                AnnotationVisitor annotationVisitor0 = methodVisitor.visitAnnotation("Lcom/test/cases/method/instruction/Instruction;", true);
                annotationVisitor0.visit("value", 0x5b);
                annotationVisitor0.visit("name", "dup_x2");
