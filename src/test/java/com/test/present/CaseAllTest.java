...
public class CaseAllTest extends PresenterTestBase {

    /**
     * Test all items in the constant pool in {@link java.lang.Object}
     */
    @Test
    public void test() throws IOException {
        String[] results = getResults(Object.class, PresentKind.CONSTANT_POOL);
        List<String> realLines = Arrays.stream(results).filter(e -> e.contains("#")).toList();
        // how to generate the elements inside List.of(...)
        // javap -v 'java.lang.Object' | grep -E '^ *#' | sed -e 's/"/\\"/g' | sed -e 's/^/"/' -e 's/$/",/'
