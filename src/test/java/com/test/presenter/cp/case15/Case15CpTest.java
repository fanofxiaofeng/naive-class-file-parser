...
public class Case15CpTest extends ConstantPoolPresenterTestBase {
    ...
    public void test() {
        expectedLines = List.of(
                "  #24 = MethodHandle       6:#25          // REF_invokeStatic com/test/cases/Case15.lambda$f$0:()V",
                "  #27 = MethodHandle       6:#28          // REF_invokeStatic java/lang/invoke/LambdaMetafactory.metafactory:(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;"
        );
    }
}
